  ...
  return (
    <div className="mx-auto px-4 py-8 md:px-8 max-w-6xl animate-fadeIn">
      ...
      {!isAdmin && isExportModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/60 p-4 pb-24 sm:p-6 sm:pb-6 backdrop-blur-sm animate-fadeIn">
          <div className="bg-white rounded-3xl w-full max-w-2xl max-h-full flex flex-col shadow-2xl overflow-hidden animate-slideUp sm:animate-fadeIn">
