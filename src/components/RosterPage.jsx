          ...
          <table className="min-w-full border-collapse border border-slate-300 text-center font-sans text-sm">
            <thead>
              ...
              <tr className="bg-slate-800 text-white border border-slate-800 select-none">
                <th
                  rowSpan={2}
                  className="border border-slate-300 px-4 py-3 font-bold align-middle uppercase tracking-wider text-xs w-16"
                >
                  DATE
                </th>
                <th
                ...
                <th
                  colSpan={3}
                  className="border border-slate-300 px-4 py-2.5 font-bold uppercase tracking-wider text-xs bg-slate-750"
                >
                  MEDICAL OFFICER
                </th>
              </tr>
              ...
              <tr className="bg-slate-700 text-white border border-slate-700 select-none">
                <th className="border border-slate-300 px-4 py-2 font-bold uppercase tracking-wider text-xs w-1/3">
                  AM
                </th>
                <th className="border border-slate-300 px-4 py-2 font-bold uppercase tracking-wider text-xs w-1/3">
                  PM
            ...
            <tbody className="divide-y divide-slate-300">
              {daysInMonthList.map(({ dayNum, dayName, dateStr }, dayIndex) => {
                ...
                return (
                  ...
                  >
                    {/* Date */}
                    <td className="border border-slate-300 px-4 py-3 font-bold text-slate-800 align-middle select-none">
                      {dayNum}
                    </td>

                    {/* Day Name */}
                    <td className={`border border-slate-300 px-4 py-3 font-bold align-middle select-none ${
                      ...
                      <td key={shiftCol} className="border border-slate-300 p-0 align-middle h-14">
                        {isEditMode ? (
                          <textarea
                            ...
                            className={`w-full h-full min-h-[3.5rem] px-4 py-2 text-center text-sm font-bold bg-transparent outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500 transition-all hover:bg-slate-50 focus:bg-white resize-none overflow-hidden ${
                          ...
                          <div className="flex flex-col items-center justify-center gap-1.5 py-2">
                            {dayAssignments[shiftCol].length > 0 ? (
                              dayAssignments[shiftCol].map((name) => (
                                <span
                                  key={name}
                                  className={`block tracking-wide uppercase text-xs font-bold transition-all px-2 py-0.5 rounded-lg ${
                                    isMatch(name)
